def CVSIM_plot(config):
        ...
        if cerebralModelOn==1:
                ...
                if oxy_switch == 1:
                        ...
                        plt.plot(t_eval_trans[7000:], store_oxygen[0][7000:], label='dC_t/dt (Oxygen Concentration in Tissue)')
                        plt.xlabel('Time (s)')
                        plt.ylabel('dC_t/dt (m3 O2/m3 tissue)')
                        plt.title('Tissue Oxygen Concentration Changes vs Time')
                        plt.legend(loc='upper left')
                        plt.grid(True)
                        ax = plt.gca()
                        ...
                        plt.figure(figsize=(10, 6), dpi=300)
                        plt.plot(t_eval_trans[10000:16000], store_oxygen[0][10000:16000], label='dC_t/dt (Oxygen Changes in Tissue)')  
                        plt.xlabel('Time (s)')
                        plt.ylabel('dC_t/dt (m3 O2/m3 tissue)')
                        plt.title('Tissue Oxygen Concentration Changes vs Time')
                        plt.legend(loc='upper left')
                        ...
                        plt.figure(figsize=(10, 6), dpi=300)
                        plt.plot(t_eval_trans[7000:7600], store_Cc[0][7000:7600], label='C_c (Oxygen Concentration in plasma)')  
                        plt.xlabel('Time (s)')
                        plt.ylabel('C_c (m3 O2/m3 plasma)')
                        plt.title('Plasma Oxygen Concentration vs Time')
                        plt.legend(loc='upper left')
                        ...
                        plt.title('Diffusion from plasma to tissue vs Time')
                        plt.legend(loc='upper left')
                        plt.grid(True)
                        ax = plt.gca()
                        ax.yaxis.set_major_formatter(ScalarFormatter(useMathText=True))
                        ...
                        plt.figure(figsize=(10, 6), dpi=300)
                        plt.plot(t_eval_trans[7000:], store_dc[0][7000:], label='dC_c/dt (Oxygen Concentration in plasma)')  
                        plt.xlabel('Time (s)')
                        plt.ylabel('dC_c/dt (m3 O2/m3 plasma)')
                        plt.title('Change of Oxygen Concentration in plasma vs Time')
                        plt.legend(loc='upper left')
                        plt.grid(True)
                        ax = plt.gca()
                        ax.yaxis.set_major_formatter(ScalarFormatter(useMathText=True))
                        ...
                        plt.figure(figsize=(10, 6), dpi=300)
                        plt.plot(t_eval_trans[7000:], store_SaO2[0][7000:]*100, label='SaO2 (Oxygen Saturation)')  
                        plt.xlabel('Time (s)')
                        plt.ylabel('SaO2 (%)')
